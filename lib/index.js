...
internals.root = function () {
    ...
    root.execute = function (...args) {

        const callback = args.pop();
        const flow = (!args.slice(-1).pop()._isMercy) ? this.flow(args.pop()) : args.pop();
    ...
    root.input = function (...args) {

        return new internals.input(...args);
    }

    root.wait = function (...args) {

        return new internals.wait(...args);
    }

    // root.prepare = function (...args) {
    //
